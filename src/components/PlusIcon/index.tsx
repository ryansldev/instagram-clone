...
const PlusIcon: FC<{ color?: string; fill?: string }> = ({ color = "#262626", fill = "#262626" }) => {
  return (
    <svg aria-label="Nova publicação" color={color} fill={fill} height="24" role="img" viewBox="0 0 24 24" width="24">
